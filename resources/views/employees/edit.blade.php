...
@section('content')
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form class="form-validate-jquery" action="{{ route('employees.update', $user->user_id)}}" method="post">
					@method('PATCH')
					@csrf
					<fieldset class="mb-3">
						...
						<div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="number" name="phone_number" class="form-control border-teal border-1 @error('phone_number') is-invalid @enderror" placeholder="Telepon" value="{{ ( old('phone_number') ) ? old('phone_number') : @$user->employee->phone_number }}" required autocomplete="off">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="text" name="alamat" class="form-control border-teal border-1 @error('alamat') is-invalid @enderror" placeholder="Alamat" required autocomplete="off" value="{{ ( old('alamat') ) ? old('alamat') : @$user->employee->alamat }}">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-lg-10">
								<div class="input-group">
									...
									<input type="number" name="gaji_pokok_employee" class="form-control border-teal border-1 @error('gaji_pokok_employee') is-invalid @enderror" placeholder="Gaji Pokok" value="{{ ( old('gaji_pokok_employee') ) ? old('gaji_pokok_employee') : @$user->employee->gaji_pokok_employee }}" required autocomplete="off">
								</div>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-lg-10">
								<div class="input-group">
									...
									<input type="number" name="uang_makan_employee" class="form-control border-teal border-1 @error('uang_makan_employee') is-invalid @enderror" placeholder="Uang Makan" value="{{ ( old('uang_makan_employee') ) ? old('uang_makan_employee') : @$user->employee->uang_makan_employee }}" required autocomplete="off">
								</div>
							</div>
						</div>
					</fieldset>
