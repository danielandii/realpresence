			...
			<table class="table datatable-basic table-hover">
				...
				@if(!$users->isEmpty())
				    ...
				    <tr> 
				        ...
				        <td align="center">
							<a href="{{ route('salaries.show',$user->id)}}" class="badge badge-info rounded-round py-2 px-3"><i class="fas fa-money-check-alt mr-1"></i> <span style="font-family: elephant">Print</span></a>
				        </td>
				    </tr>
				    @endforeach
				@else
